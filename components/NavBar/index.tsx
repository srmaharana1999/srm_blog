...
const NavBar = () => {
  ...
  return (
    <div className="group fixed w-full left-1/2 -translate-x-1/2 top-0 bg-[#cccccc]  border-b-1 border-border z-100 ">
      <div className=" mx-auto h-20 text-black flex justify-between items-center px-4">
        ...
        <div className=" hidden lg:block">
          {!session ? (
            ...
            <div className="hidden lg:flex gap-4 lg:mr-16">
              {session.user ? (
                <UserMenu
              ...
              {!session ? (
                ...
                <div>
                  <button
                    type="button"
                    onClick={() => signOut()}
                    className="text-white font-bold bg-red-500 px-6 py-2 border-shadow text-sm"
                  >
                    Sign out
                  </button>
                </div>
