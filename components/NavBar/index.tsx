...
const NavBar = () => {
  ...
  return (
    <div className="group fixed w-full left-1/2 -translate-x-1/2 top-0  border-b-1 border-border z-30 ">
      <div className=" max-w-7xl mx-auto w-full h-20 text-black flex justify-between items-center px-6 ">
        <div className="text-white bg-white  lower-bar p-2 border-shadow">
